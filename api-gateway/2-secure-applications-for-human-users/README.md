# Secure applications for Human users
...
As we can see, the `Sub` header of the authentication has been added to the request. A JWT Access Token is in the bearer. We can decode it on https://jwt.io :
